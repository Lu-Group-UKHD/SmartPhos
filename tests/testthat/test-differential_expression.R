...
test_that("plotBox generates a ggplot object without subjectID", {
...
test_that("plotBox generates a ggplot object with subjectID", {
...
test_that("plotBox handles missing gene/feature ID gracefully", {
  se <- create_mock_se(with_subjectID = FALSE)
  result <- performDifferentialExp(
    se = se, 
    assay = "Intensity", 
  ...
  expect_error(plotBox(result$seSub, id = "nonexistent_gene", symbol = "Nonexistent Gene"), 
               "subscript out of bounds")
})

test_that("plotBox includes correct elements in the plot with subjectID", {
  se <- create_mock_se(with_subjectID = TRUE)
  result <- performDifferentialExp(
    se = se, 
    assay = "Intensity", 
...
test_that("plotBox handles different comparison groups", {
  se <- create_mock_se(with_subjectID = FALSE)
